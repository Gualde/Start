...
public class MainLogin extends Activity {
    ...
    private void mostrarPosicion(Location localizacion) {
    	if (localizacion!=null) {
    		...
    		edtPrecision.setText("Precisi�n: " + String.valueOf(localizacion.getAccuracy()));
    	}
    	else {
    		edtLatitud.setText("Latitud: (Sin datos)");
    		edtLongitud.setText("Longitud: (Sin datos)");
    		edtPrecision.setText("Precisi�n: (Sin datos)");    		
    	}
    }
    ...
    {
    	Toast mensaje = Toast.makeText(this, "�El GPS est� deshabilitado!", Toast.LENGTH_SHORT);
    ...
    {
    	Toast mensaje = Toast.makeText(this, "�El Operador de Telefon�a est� desconectado!", Toast.LENGTH_SHORT);
		mensaje.setGravity(Gravity.BOTTOM|Gravity.CENTER, 0, 0);
		mensaje.show();	
    }
}
...
/*
	...
	//nos basaremos siempre a la hor de utilizar la API de localizaci�n de Android.
	...
	//A continuaci�n vamos a obtener las propiedades del primero de los proveedores obtenidos.
	...
	//Obtenemos la propiedad de la precisi�n del proveedor.
